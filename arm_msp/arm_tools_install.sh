...
# CCS (code composer): CCS6.1.3.00034_linux.tar.gz
...
echo "***"
echo "*** Downloading Code Compactor"
wget -nv -O ccs_install.tgz http://tinyprod.net/dev-archive/CCS${CCS_VERSION}_linux.tar.gz

echo "*** Installing Code Compressor"
tar xf ccs_install.tgz
(cd CCS${CCS_VERSION}_linux; ./ccs_setup_${CCS_VERSION}.bin --mode unattended --prefix /opt/ti )

echo "*** Installing Emu Pack"
# ./ti_emupack --mode unattended --prefix /opt/ti/ccsv6
